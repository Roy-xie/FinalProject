$(function () {
    ...
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/city/Taipei.jpg" alt="">
          <span>臺北市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='NewTaipei' city_name_Tw='新北市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/city/NewTaipei.jpg" alt="">
          <span>新北市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Taoyuan' city_name_Tw='桃園市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/city/Taoyuan.jpg" alt="">
          <span>桃園市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Taichung' city_name_Tw='臺中市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/city/Taichung.jpg" alt="">
          <span>臺中市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Tainan' city_name_Tw='臺南市'> 
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/city/Tainan.jpg" alt="">
          <span>臺南市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Kaohsiung' city_name_Tw='高雄市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/city/Kaohsiung.jpg" alt="">
          <span>高雄市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Other' city_name_Tw='其他縣市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/city/Other.jpg" alt="">
          <span>其他縣市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Taipei' city_name_Tw='臺北市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/Food/Taipei.jpg" alt="">
          <span>臺北市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='NewTaipei' city_name_Tw='新北市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/Food/NewTaipei.jpg" alt="">
          <span>新北市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Taoyuan' city_name_Tw='桃園市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/Food/Taoyuan.jpg" alt="">
          <span>桃園市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Taichung' city_name_Tw='臺中市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/Food/Taichung.jpg" alt="">
          <span>臺中市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Tainan' city_name_Tw='臺南市'> 
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/Food/Tainan.jpg" alt="">
          <span>臺南市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Kaohsiung' city_name_Tw='高雄市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/Food/Kaohsiung.jpg" alt="">
          <span>高雄市</span>
        </a>
      </div>
    </div>
  ...
  <div class="city_container" id='Other' city_name_Tw='其他縣市'>
    <div class="thumbex">
      <div class="thumbnail">
        <a href="javascript:void(0)">
          <img src="./img/Food/Other.jpg" alt="">
          <span>其他縣市</span>
        </a>
      </div>
    </div>
...
<div class="singleCity" >
  ...
  let tra_html = `
   <div class='container-List'>
        <img src='./img/TRA_LOGO.webp' style='width:80%; height:60%; margin: 15px 0;background-color: #fff;padding: 1em;border-radius: 10px;'></img>
        ...
        <div class="alert alert-success  fade show d-flex justify-content-center" role="alert">
  ...
  let thsr_html = `
   <div class='container-List'>
   <img src='./img/THSR_LOGO.webp' style='width:80%; height:60%; margin: 15px 0;background-color: #fff;border-radius: 10px;'></img>
  ...
  let mrt_html = `
    ...
    <div class="City d-flex my-3">
      ...
      <select class="form-select form-select-sm" id="City_List" aria-label="Default select example">
        ...
        <option value="TRTCMG">貓空纜車</option>
        <option value="NTDLRT">淡海輕軌</option>
      </select>
    </div>
  ...
  sidebar
    .addPanel({
      id: 'travel',
      tab: '<i class="fa-solid fa-cart-flatbed-suitcase"></i>',
      title: '旅遊',
      pane: travel_html,
    })
  sidebar
    .addPanel({
      id: 'food',
      tab: '<i class="fa-solid fa-utensils"></i>',
      title: '美食',
      pane: food_html,
    })
  ...
  sidebar
    .addPanel({
      id: 'bus',
      tab: '<i class="fa-solid fa-bus-simple"></i>',
      title: '公車',
      pane: bus_html,
    })
    ...
    .addPanel({
      id: 'thsr',
      tab: '<i class="twicon-high-speed-rail" title="高鐵"></i>',
      title: '高鐵',
      pane: thsr_html,
    })
    ...
    .addPanel({
      id: 'bike',
      tab: '<i class="fa-solid fa-bicycle"></i>',
      title: '自行車',
      pane: bike_html,
    })
  ...
  function select_Route(route) {
    ...
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Rail/Metro/ODFare/${route}?$select=${select}&$format=JSON`,
      dataType: "json",
      contentType: 'json',
  ...
  $('button#go_Search_MRT').on('click', function () {
    ...
    setTimeout(function () {
      ...
      <label>起站: ${origin_List.val()}</label>
      <label>迄站: ${Destination_List.val()}</label>`;
      for (let index = 0; index < mrt_FareInfo.length; index++) {
        ...
        if (station_Name_O == origin_List.val() &&
          ...
          if (travel_Time) {
            mrt_Result_Content = mrt_Result_Content + `<label>到達時間約: ${travel_Time}分鐘</label>`;
          }
          if (travel_Distance) {
            mrt_Result_Content = mrt_Result_Content + `<label>路程距離: ${travel_Distance}公里</label>`;
          }
          for (let i = 0; i < fares.length; i++) {
            if (fares[i]['TicketType'] == 1) {
              switch (fares[i]['FareClass']) {
                case 1:
                  mrt_Result_Content = mrt_Result_Content + `<label>成人票: $${fares[i]['Price']}</label>`;
                  break;
                case 2:
                  mrt_Result_Content = mrt_Result_Content + `<label>學生票: $${fares[i]['Price']}</label>`;
                  break;
                case 3:
                  mrt_Result_Content = mrt_Result_Content + `<label>孩童票: $${fares[i]['Price']}</label>`;
                  break;
                case 4:
                  mrt_Result_Content = mrt_Result_Content + `<label>敬老票: $${fares[i]['Price']}</label>`;
                  break;
                case 5:
                  mrt_Result_Content = mrt_Result_Content + `<label>愛心票: $${fares[i]['Price']}</label>`;
                  break;
                case 6:
                  mrt_Result_Content = mrt_Result_Content + `<label>愛心孩童票: $${fares[i]['Price']}</label>`;
                  break;
                case 7:
                  mrt_Result_Content = mrt_Result_Content + `<label>愛心優待 / 愛心陪伴票: $${fares[i]['Price']}</label>`;
                  break;
                case 8:
                  mrt_Result_Content = mrt_Result_Content + `<label>團體票: $${fares[i]['Price']}</label>`;
                  break;
              }
            }
          }
  ...
  $.ajax({
    url: `https://tdx.transportdata.tw/api/basic/v2/Rail/TRA/Station?$select=${select}&$format=JSON`,
    dataType: "json",
    contentType: 'json',
    headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token }, 
    async: false,
      ...
      success: function (result) {
        ...
        Object.keys(result['ODFares']).forEach(function (value, key) {
          ...
          Object.keys(result['ODFares'][value]['Fares']).forEach(function (index, key) {
            ...
            <div class='fare_Item'>
              <label>${fareClass}票</label>
              <label>${cabinClass}</label>
              <label>$${fares[index]['Price']}</label>
            </div>
          `;
          });
          ...
          success: function (result) {
            ...
            for (let index = 0; index < result.length; index++) {
              ...
              <div class = 'single_Tra_Time' data-trainType = '${trainTypeName}'>
                  <label>日期: ${train_Date}</label>
                  <label><i class="fas fa-subway" style='color: ${train_Type_Color};'></i> ${trainTypeName}_No.${train_No}</label><br>
                  <label>(${startingStationName}  →  ${endingStationName})</label><br>
                  <label>起站: <i class="far fa-clock" title="上車時間" style='color: blue'></i> ${O_DepartureTime}   ${O_stationName}</label><br>
                  <label>迄站: <i class="far fa-clock" title="下車時間" style='color: blue'></i> ${D_ArrivalTime}   ${D_stationName}</label><br>
                  <label>需花費: ${resultTime}</h2><br>
                  <label><span class='badge bg-secondary' style ='cursor:pointer;' id='ticket_Show' data-num=${index} onclick=ticket_toggle(${index})>票價顯示 / 隱藏</span></label><br>
              </div>
              `;
  ...
  let THSR_Ticket_Search = function (index, O_id, D_id, Direction) {
    ...
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Rail/THSR/ODFare/${O_id}/to/${D_id}?$filter=${filter}&$format=JSON`,
      dataType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token },
      async: false,
      contentType: 'json',
      success: function (result) {
        ...
        // Object.keys(result['ODFares'][value]['Fares']).forEach(function (index, key) {
          let ticketType = '';
          switch (result[0]['Fares'][value]['TicketType']) {
            case 1:
              ticketType = '一般票';
              break
            case 2:
          ...
          let fareClass = '';
          // FareClass (Int32): 費率等級 = ['1: 成人', '2: 學生', '3: 孩童', '4: 敬老', '5: 愛心', '6: 愛心孩童', '7: 愛心優待/愛心陪伴', '8: 團體', '9: 軍警'] ,
          switch (result[0]['Fares'][value]['FareClass']) {
            case 1:
              fareClass = '成人';
              break
            case 2:
          ...
          let cabinClass = '';
          // CabinClass (Int32): 艙等 = ['1: 標準座車廂', '2: 商務座車廂', '3: 自由座車廂'] ,
          switch (result[0]['Fares'][value]['CabinClass']) {
            case 1:
              cabinClass = '標準座車廂';
              break
            case 2:
          ...
          return_Text = return_Text + `
            <div id="THSR_item" class='fare_Item'>
              <label>${cabinClass}</label>
              <label> ${ticketType}[${fareClass}]</label>
              <label>$${result[0]['Fares'][value]['Price']}</label>
            </div>
          `;
        });
          ...
          success: function (result) {
            ...
            for (let index = 0; index < result.length; index++) {
              ...
              <div class = 'single_Thsr_Time' >
                  <label>日期: ${nowDate}</label>
                  <label><i class="fas fa-subway"></i>  No. ${train_No}</label>
                  <label>(${startingStationName}  →  ${endingStationName})</label><br>
                  <label>起站: <i class="far fa-clock" title="上車時間" style='color: blue'></i> ${O_DepartureTime}   ${O_stationName}</label> →
                  <label>迄站: <i class="far fa-clock" title="下車時間" style='color: blue'></i> ${D_ArrivalTime}   ${D_stationName}</label>
                  <label>需花費: ${resultTime}</h2><br>
                  <label><span class='badge bg-secondary' style ='cursor:pointer;' id='ticket_Show_THSR' data-num=${index} onclick=ticket_toggle_THSR(${index})>票價顯示 / 隱藏</span></label>
              </div>
              `;
  ...
  $('.container-travel .city_container').on('click', function () {
    ...
    if ($(this).attr('id') != 'Other') {
      $.ajax({
        ...
        dataType: 'json',
        contentType: 'json',
        headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token }, // 憑證 API token
        async: false,
        success: function (result) {
          // console.log(result);
      ...
      if ($('input.search-value').val()) {
        Object.keys(travel_Info).forEach(function (value, key) {
          ...
          if (choose_Items.includes(travel_Info[value]['Class1'])
            ...
            && (travel_Info[value]['ScenicSpotName'].includes($('input.search-value').val())
              || travel_Info[value]['Address'].includes($('input.search-value').val()))) {
            $('.category-Items').append(`
            <div class="travel-item" travel-id="${travel_Info[value]['ScenicSpotID']}">
              <h2 class="view_Name">${travel_Info[value]['ScenicSpotName']}
              </h2>
                  <div class ="view_Span">
                      ${is_Span_1}
                      ${is_Span_2}
              ...
              <h3 class="view_address">${travel_Info[value]['Address'] ? travel_Info[value]['Address'] : "並無提供地址"}
                <i class="fas fa-location-arrow" id="go_View_Pos" title="前往該座標位置"  data-number = "${value}" pos-Lat="${travel_Info[value]["Position"]["PositionLat"]}" pos-Lng="${travel_Info[value]["Position"]["PositionLon"]}" view="${travel_Info[value]['ScenicSpotName']}"></i>
              </h3>
              <h3 class="view_opentime">
                  <i class="far fa-clock" title="開放時間"></i>
                  ${travel_Info[value]['OpenTime'] === 'N/A' || !travel_Info[value]['OpenTime'] ? "未公開" : travel_Info[value]['OpenTime']}
              </h3>
              </div>`);
          }
        })
        ...
        Object.keys(travel_Info).forEach(function (value, key) {
          ...
          if (choose_Items.includes(travel_Info[value]['Class1'])
            ...
            $('.category-Items').append(`
                <div class="travel-item" travel-id="${travel_Info[value]['ScenicSpotID']}">
                  <h2 class="view_Name">${travel_Info[value]['ScenicSpotName']}</h2>
                  <div class ="view_Span">
                      ${is_Span_1}
                      ${is_Span_2}
                      ${is_Span_3}
  ...
  $('input.search-value').on('input', function () {
    ...
    if (input_Val) {
      ...
      Object.keys(travel_Info).forEach(function (value, key) {
        ...
        let is_Span_2 = travel_Info[value]['Class2'] && travel_Info[value]['Class2'] !== travel_Info[value]['Class1'] ? `<span class = "badge bg-success">${travel_Info[value]['Class2']}</span>` : "";
        let is_Span_3 = travel_Info[value]['Class3'] && travel_Info[value]['Class3'] !== travel_Info[value]['Class2'] ? `<span class = "badge bg-success">${travel_Info[value]['Class3']}</span>` : "";
        if (travel_Info[value]['ScenicSpotName'].includes($('input.search-value').val()) || travel_Info[value]['Address'].includes($('input.search-value').val())) {
          $('.category-Items').append(`
          <div class="travel-item" travel-id="${travel_Info[value]['ScenicSpotID']}">
              <h2 class="view_Name">${travel_Info[value]['ScenicSpotName']}</h2>
              <div class ="view_Span">
  ...
  $('.container-food .city_container').on('click', function () {
    ...
    if ($(this).attr('id') != 'Other') {
      let select = 'RestaurantName,Address,Description,Phone,OpenTime,WebsiteUrl,Position,Picture';
      $.ajax({
        url: `https://tdx.transportdata.tw/api/basic/v2/Tourism/Restaurant/${city_name}?%24format=JSON`,
        dataType: 'json',
        contentType: 'json',
        headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token }, // 憑證 API token
        async: false,
        success: function (result) {
          ...
          Object.keys(result).forEach(function (value, key) {
            food_Items_Content = food_Items_Content + `
              <div class="food-item" id = 'go_Restaurant_Pos'>
              ...
              ${result[value]["RestaurantName"]}
                ...
                <h3 class="view_opentime my-1">
                    <i class="far fa-clock" title="開放時間"></i>
                    ${result[value]['OpenTime'] === 'N/A' || !result[value]['OpenTime'] ? "未公開" : result[value]['OpenTime']}
                </h3>
              </div>
            `;
          });
  ...
  $('span#city_filter_food').on('click', function () {
    ...
    let select = 'RestaurantName,Address,Description,Phone,OpenTime,WebsiteUrl,Position,Picture';
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Tourism/Restaurant/${city_name}/?select=${select}?%24format=JSON`,
      dataType: 'json',
      contentType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token },
      async: false,
  ...
  $('.Food-category-Items').on('click', 'i#go_Restaurant_Pos', function () {
    ...
    let fly_Marker_Content = `
      <h2>${restaurant_Info[data_Num]['RestaurantName']}</h2>
  ...
  $('input.search-food').on('input', function () {
    ...
    if (input_Val) {
      ...
      Object.keys(restaurant_Info).forEach(function (value, key) {
        if (restaurant_Info[value]['RestaurantName'].includes($('input.search-food').val()) || restaurant_Info[value]['Address'].includes($('input.search-food').val())) {
          food_Items_Content = food_Items_Content + `
            <div class="food-item">
            <h2 class="restaurant_Name">
              <span class='badge bg-warning mx-1'>
            ...
            ${restaurant_Info[value]["RestaurantName"]}
            </h2>
            <h3 class="food_address my-1">
            ...
            <h3 class="view_opentime my-1">
                <i class="far fa-clock" title="開放時間"></i>
                ${restaurant_Info[value]['OpenTime'] === 'N/A' || !restaurant_Info[value]['OpenTime'] ? "未公開" : restaurant_Info[value]['OpenTime']}
            </h3>
  ...
  let get_CurrentBus_Stop = function (city, route_id, direct) {
    ...
    $.ajax({
      type: 'GET',
      url: `https://tdx.transportdata.tw/api/basic/v2/Bus/RealTimeNearStop/City/${city}?$select=PlateNumb,StopName&$filter=RouteUID eq '${route_id}' AND Direction eq ${direct}&$format=JSON`,
      dataType: 'json',
      contentType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token }, // 憑證 API token
      async: false,
  ...
  let get_CurrentBus_Pos = function (city, route_id, direct) {
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Bus/RealTimeByFrequency/City/${city}?$select=BusPosition,PlateNumb&$filter=RouteUID eq '${route_id}' AND Direction eq ${direct}&$format=JSON`,
      dataType: 'json',
      contentType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token }, // 憑證 API token
      async: false,
  ...
  bus_update_Time = function (city_name, route_UID, direct) {
    ...
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Bus/EstimatedTimeOfArrival/City/${city_name}/?$select=${select}&$filter=${filter}&$format=JSON`,
      dataType: 'json',
      contentType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token },
      async: false,
  ...
  stop_Start_End = function (city_name, route_UID) {
    ...
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Bus/Route/City/${city_name}/?$select=${select}&$filter=${filter}&$format=JSON`,
      dataType: 'json',
      contentType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token },
      async: false,
  ...
  click_bus_info = function (city, route, route_id, direct) {
    window.estimate_Bus = setTimeout(function () {
      ...
      if (!is_show) {
        ...
        $.ajax({
          url: `https://tdx.transportdata.tw/api/basic/v2/Bus/StopOfRoute/City/${city}?$select=${select}&$filter=${filter}&$format=JSON`,
          dataType: 'json',
          contentType: 'json',
          headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token },
          async: false,
  ...
  let get_bus_info = function (city) {
    ...
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Bus/Route/City/${city}?$select=${select}&$orderby=${orderBy}&$format=JSON`,
      dataType: 'json',
      contentType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token },
      async: false,
  ...
  $('.city_Bike').on('click', function () {
    ...
    $.ajax({
      url: `https://tdx.transportdata.tw/api/basic/v2/Cycling/Shape/City/${select_City}?&$format=JSON`,
      async: false,
      dataType: 'json',
      contentType: 'json',
      headers: { "authorization": "Bearer " + GetAuthorizationHeader().access_token },
